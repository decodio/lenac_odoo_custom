...
# Copyright (C) 2019 Vedran Terihaj
...
class VlPalumboExchange(models.Model):
    _name = 'vl.palumbo.exchange'

    name = fields.Char('Exchange name')
    ...
    def create(self, vals):
        res = super(VlPalumboExchange, self).create(vals)
        if res:
