...

{
    ...
    'depends': ['sp_viktor_lenac_dms_qms', 'website_partner', 'website_mail', 'website_form', 'survey', 'website_form_builder',],  # List dependent modules, sp_viktor_lenac_dms_qms is a safe bet
    'data': [
